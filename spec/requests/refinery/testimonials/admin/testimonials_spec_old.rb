      ...
      describe 'testimonials' do
        ...
        describe 'create' do
          ...
          context 'duplicate' do
            before { FactoryGirl.create(:testimonial, :name => 'UniqueTitle', :quote=> 'Quote') }
        ...
        describe 'edit' do
          before { FactoryGirl.create(:testimonial, :name => 'A name', :quote=> 'Quote') }
        ...
        describe 'destroy' do
          before { FactoryGirl.create(:testimonial, :name => 'UniqueTitleOne', :quote=> 'Quote') }
